...
/**
 * The class represents a single user, which can be used to launch the game. Inside here we have the local stored information, the temporarily saved authentication data (like password), and some data about the skin.
 *
 * @author Max
 */
public class User
{
    ...
    /**
     * The method sets the unique UUID of the player. This might get important later on, where Mojang will allow more profiles for account.
     *
    ...
    /**
     * The method returns a boolean value to express the migration status of the account(Either Mojang or old Minecraft).
     *
    ...
    /**
     * The methods sets status of the account. If true, the account hasn't been migrated yet. Otherwise the value should default to false.
     *
