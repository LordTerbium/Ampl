...
/**
 * The class is a JSON-structure for the error handling during the authentication process. Created by Max on
 * 23.06.2014.
 */
public class ErrorResponse {
    ...
    public ErrorResponse() {
        ...
        errorMap.put(Error.METHOD_NOT_ALLOWED,
                "Something other than a POST request was recieved. What are you trying to do?");
        errorMap.put(Error.NOT_FOUND, "You called a non existing endpoint. What are you working out?");
        errorMap.put(Error.FORBIDDEN_OPERATION_EXCEPTION,
                "This account doesn't exist. Control your username and password.");
        errorMap.put(Error.USER_MIGRATED_EXCEPTION,
                "Invalid username. The account was migrated. Try with your Mojang credentials.");
    ...
    /**
     * An Enum with all known and unknown exceptions. This simplifies the error handling reducing the amount of lines to
     * write.
     */
