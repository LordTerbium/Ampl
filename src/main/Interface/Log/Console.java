...
public class Console extends JFrame {
    ...
    public PipedInputStream login = new PipedInputStream();
    ...
    public Console(Point location) {
        ...
        setLocation(new Point(location.x - 300, location.y - 200));
        setSize(WIN_SIZE);
    ...
    private void initContextMenu() {
        ...
        copy.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                StringSelection select = new StringSelection(console
                        .getSelectedText());
    ...
    public synchronized void write(String text) {
        ...
        try {
            ...
            logger.fatal("Can't write the text. <br>" + e.getStackTrace());
        } catch (IOException e) {
            logger.fatal("Can't write the text. <br>" + e.getStackTrace());
        }
    }
